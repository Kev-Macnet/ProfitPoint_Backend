...
public class PtRehabilitationFeeDao {
    ...
    public java.util.Map<String, Object> findOne(long ptId) {
        String sql;
        sql = "Select PT_ID, EXCLUDE_NHI_NO_ENABLE, PATIENT_NDAY_ENABLE, PATIENT_NDAY_DAYS, PATIENT_NDAY_TIMES, INCLUDE_ICD_NO_ENABLE, COEXIST_NHI_NO_ENABLE, MIN_COEXIST, LIM_DIVISION_ENABLE\r\n"
    ...
    // pt_id, exclude_nhi_no_enable, patient_nday_enable, patient_nday_days, patient_nday_times, include_icd_no_enable, coexist_nhi_no_enable, min_coexist, lim_division_enable
    public int add(long ptId, int exclude_nhi_no_enable, int patient_nday_enable, int patient_nday_days, int patient_nday_times, 
            int include_icd_no_enable, int coexist_nhi_no_enable, int min_coexist, int lim_division_enable) {
        String sql;
        sql = "Insert into\r\n"
