...
public class MR {
  ...
  public MR(IP_D ipd) {
    ...
    // this.totalDot = (ipd.getApplDot() == null) ? 0 : ipd.getApplDot();
    // if (ipd.getPartDot() != null) {
    // this.totalDot = this.totalDot + ipd.getPartDot();
    // }
    // 醫療+不計入+自費
...
//    } else {
  ...
  public void updateMR(OP_D opd, List<FILE_DIFF> diffList, CodeTableService codeTableService) {
    ...
    if (this.applDot == null) {
      this.applDot = Integer.valueOf(0);
    }
