...
public class MR {
   ...
   */
  @ApiModelProperty(value = "資料格式，與IP_T, OP_T的DATA_FORMAT值一樣。10:門診，20:住院，30:特約藥局，40:特約物理(職能)治療所...", example = "10", required = false)
   ...
   */
  @ApiModelProperty(value = "病歷狀態，-2: 待確認，-1: 疑問標示，0: 待處理，1: 無需變更，2: 優化完成，3: 評估不調整", example = "1", required = true)
  @Column(name = "STATUS")
