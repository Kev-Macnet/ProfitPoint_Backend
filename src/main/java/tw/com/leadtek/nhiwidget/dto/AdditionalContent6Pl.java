...
public class AdditionalContent6Pl {
    ...
    private java.util.List<AdditionalContent6ListPl> data;
    ...
    public java.util.List<AdditionalContent6ListPl> getData() {
        return data;
    }
    public void setData(java.util.List<AdditionalContent6ListPl> data) {
        this.data = data;
    }
