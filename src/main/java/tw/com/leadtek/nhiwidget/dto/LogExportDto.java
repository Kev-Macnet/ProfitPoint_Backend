...
@ApiModel(value = "LOG_EXPORT_DTO", description = "LOG_EXPORT_DTO")
public class LogExportDto{
	...
	@ApiModelProperty(value = "匯出筆數", example = "100", required = true)
	...
	public String toString() {
		return "LogExportDto [displayName=" + displayName + ", username=" + username + ", createDate=" + createDate
