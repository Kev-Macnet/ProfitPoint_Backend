...
@ApiModel(description = "支付條件設定搜尋 DTO")
public class PaymentTermsSearchDto {
    @ApiModelProperty(value="代碼", example="1606924800000")
    private long id;
    
    @ApiModelProperty(value="分類", example="門診診察費")
    private String category;
    
    @ApiModelProperty(value="院內碼",example="abc001")
    private String fee_no;
    @ApiModelProperty(value="院內碼名稱", example="掛號費")
    private String fee_name;
    
    @ApiModelProperty(value="支付標準代碼", example="abc001")
    private String nhi_no;
    @ApiModelProperty(value="支付標準代碼名稱", example="掛號費")
    private String nhi_name;

    @ApiModelProperty(value="生效日(timestamp)", example="1627228800000")
    private long start_date;
    @ApiModelProperty(value="失效日(timestamp)", example="1627228800000")
    private long end_date;
    
    @ApiModelProperty(value="醫院層級(1醫學中心/2區域醫院/3地方醫院/4基層診所)", example="2")
    private int hospital_type;
    @ApiModelProperty(value="就醫方式(門急)(1/0)", example="1")
    private int outpatient_type;
    @ApiModelProperty(value="就醫方式(住院)(1/0)", example="0")
